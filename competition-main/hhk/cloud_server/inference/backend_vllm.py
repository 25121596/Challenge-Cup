...
Proxies requests to a running vLLM server.  vLLM natively speaks the
OpenAI-compatible /v1/chat/completions protocol, so this adapter is
nearly identical to the llama-server one but configured for vLLM's
default port (8000).
"""
...
logger = logging.getLogger("cloud_server.inference.vllm")
